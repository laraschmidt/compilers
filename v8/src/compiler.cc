...
#define FLAG_hydrogen_stats true
...
static Handle<SharedFunctionInfo> CompileToplevel(CompilationInfo* info) {
  ...
  { VMState<COMPILER> state(info->isolate());
    ...
    Logger::LogEventsAndTags mytag = Logger::ESHA_TAG;
    PROFILE(isolate,
            CodeCreateEvent(mytag, *info->code(), *result, info, *script_name)); 
